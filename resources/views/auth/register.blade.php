...
<title>Daftar - Sistem Organisasi Kampus</title>
...
<div class="register-container">
    <div class="glass-card shadow">
        <div class="brand-header">
            <h1 class="brand-title">REGISTRASI AKUN</h1>
            <p class="text-white-50 m-0 small">Gabung ke Sistem Organisasi Kampus</p>
        </div>
            ...
            <form action="/register" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="role" id="role" class="form-select" required>
                        <option value="operator" {{ old('role') === 'operator' ? 'selected' : '' }}>Operator (User Biasa)</option>
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" class="form-control" placeholder="Masukkan kembali password" required>
                </div>
                <button type="submit" class="btn btn-submit w-100 mb-3">Daftar Sekarang</button>
                <div class="text-center mt-4">
                    <p class="text-secondary small m-0">Sudah punya akun? <a href="/login" class="text-decoration-none" style="color: #a855f7; font-weight: 600;">Login di sini</a></p>
                </div>
            </form>
        </div>
    </div>
